...
export default function OrderManagementLaundryAdmin() {
  ...
  const filteredOrders = orders.filter((order) => {
    const matchId = order.id
      .toLowerCase()
      .includes(selectedFilters.id.toLowerCase());
    const matchLaundry =
      selectedFilters.laundry === "" ||
      order.laundry
        ?.toLowerCase()
        .includes(selectedFilters.laundry.toLowerCase());
    ...
    const matchesDateFrom =
      ...
      orderDate >= new Date(selectedFilters.dateFrom);
    const matchesDateTo =
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="flex flex-col md:col-span-2">
            ...
            <input
              ...
              onChange={(e) =>
                setSelectedFilters((prev) => ({ ...prev, id: e.target.value }))
              }
            />
          </div>
        </div>
